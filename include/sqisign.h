...
void first_sign(two_walk *phi, uintbig *res, GEN *x1_gen, GEN *x2_gen, proj *L_kernel, proj *Kd, proj *P3, proj *P, proj *Q, proj *PQ, eichler_package *eich, GEN I, GEN I_two, GEN K, GEN L , proj* phi_I_basis, proj *base_curve, long f, bool special_fixed);
