...
void ideal_to_isogeny_two_new2(two_walk_long *phi_res, GEN I,GEN J, GEN K, GEN L, const two_walk_long *phi_I, uintbig *zip, bool *endpoint_close_to_E0,proj *endpoint, GEN *x1_gen, GEN *x2_gen, proj *L_kernel, proj *Kd, proj *P3, proj *P, proj *Q, proj* PQ, proj *phi_I_basis, eichler_package* eichler);
