...
extern const uintbig p_even_cofactor_minus_1;
...
extern const uintbig Pxr;
extern const uintbig Pxi;
extern const uintbig Pyr;
extern const uintbig Pyi;
extern const int win;
extern const int Strategy[];
extern const uintbig Lookupbasere;
extern const uintbig Lookupbaseim;
extern const uintbig Lookuptable[];
extern const uintbig LookuptableLR[];
// The cofactor of the useful odd torsion in p+1
